var questions = [
  {
    ...
    explanation:
      "Snow can clearly be seen in the photo as well as the roadway that the man stands in as he shovels.",
  },
  ...
  },
  {
    ...
    explanation:
      "The man clearly gives a presentation in a workplace environment in front of his co-workers or another group of people.",
  },
  {
    ...
    image: "img/drive.jpg",
    explanation:
      "This image is clearly of someone driving on a highway and not a freeway since there are only two lanes and it looks more like a highway than a freeway.",
  },

  {
    ...
    explanation:
      "The men clearly are cycling on their bicycles and wear uniforms and helmets.",
  },
  {
    ...
    image: "img/house.jpg",
    explanation:
      "The image is clearly one of adults building the mostly-wooden structure of the upper part of a house or a similar edifice.",
  },
...

  {
    ...
    explanation:
      "The company workers clearly work on computers in a large hall (could be referred to as an office as well).",
  },
  ...
  },
  {
    ...
    explanation:
      "'It's the second building over from here.' This is the most direct answer to the question.",
  },
  {
    ...
    explanation:
      "The word 'commencing' refers to 'beginning' or 'starting'. Hence, the best answer is 'It start tomorrow at 8am.'",
  },
  {
    ...
    explanation:
      "Wanting to stay home with her young family is a common answer to the question of why someone (a woman named Denise who is presumably a mother) would resign from her job.",
  },
  {
    ...
    explanation:
      "A person being absent-minded is a clear and direct reason why someone might keep forgetting to lock her desk when she leaves the office for lunch or at the end of a workday.",
  },
  {
    ...
    explanation:
      "'Jenn called one.' This sentence is the most direct answer to the question: 'Who called an Uber?'",
  },
  {
    ...
    explanation:
      "A common and appropriate answer to how one can get a work promotion the fastest at many companies is to work hard.",
  },
  {
    ...
    explanation:
      "Having a lot of experience is often helpful in order to get hired at many companies, especially if the job is specialized.",
  },
  {
    ...
    explanation:
      "'The hiring manager, of course.' This reply is the most direct answer to the question: 'Who should I send a thank you card to?' Athough the other two options referred to 'the hiring manager', neither of them offer a direct answer to the question posed.",
  },
  {
    ...
    explanation:
      "'No, it isn't.' This is the best answer since it directly answers the question: 'Is a tip required?' The other choices don't directly answer the question.",
  },
  {
    ...
    explanation:
      "'Up here and down there.' This answer makes sense as a reply to the question: 'Where do I need to sign?' The assumption is that the woman replying to the question is pointing to the document where the man is supposed to sign.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "The oft-crunchy ingredient 'croutons' are optionally added to many salads. Therefore, the phrase, 'No, but ranch dressing would be nice.', makes the most sense since one might also or instead add ranch dressing to one's salad.",
  },
  {
    ...
    explanation:
      "A direct reply to the question, 'How does she manage her time so well?', is the answer: 'She uses a daily planner every day.' The reason is that by using a planner to schedule your activities, you're more likely to be able to manage your time effectively.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "The answer that features a number is the correct answer to: 'How many marketing employees do we have here?' Therefore, the correct answer is: 'We have six.'",
  },
  {
    ...
    explanation:
      "The word 'commence' refers to the word 'begin' or 'start'. Hence, the correct answer is: 'It starts at seven.'",
  },
  {
    ...
    explanation:
      "The word 'nepotism' has to do with 'people getting promoted due to being related by blood to the higher-ups at the company'. Hence, the best and most answer to the question is: 'No, no one is related here.'",
  },

  {
    ...
    explanation:
      "'Yes, in the elevator.' This is the best and most direct answer to the question: 'Have you met Mrs. Fields yet?'",
  },
  {
    ...
    explanation:
      "Although this isn't explicitly a question, the most direct reply or retort to the statement, 'Don't worry as there is auto-save in all of the software we use here.', is the answer choice: 'Okay, thank you.'",
  },
  {
...

  {
    ...
    explanation:
      "'You're like a daughter to me.' Again, while this isn't an explicit question, the answer that features the most direct response to that statement is: 'I appreciate your sentiments.'",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "'Is there a chance for growth and promotion here?' The best answer is clearly: 'No, this is a dead-end job.' A central reason is that the phrase 'dead-end job' literally means that there is no chance of growth or promotion there.",
  },
  {
    ...
    explanation:
      "The most direct answer to the question, 'How often does the bus run on weekday mornings?', is the answer: 'About every half hour.'",
  },
  {
...

  {
    ...
    explanation:
      "Since the subject of the question is 'the company', the answer must reference 'the company' or 'it' and only one answer does this: 'Yes, it has especially when looking at this year's performance data.",
  },
  {
    ...
    explanation:
      "The initial sentence emphasizes the costly 'replacement fee' for the 'fob', which is an electronic tag that allows people to get into an office building. The best answer is clearly the one that references the high price: 'That seems a bit steep for this little dongle.'",
  },
  {
    ...
    explanation:
      "The word 'horsepower' is mentioned multiple times in the discussion; hence, one could deduce that the acronym 'hp' means 'horsepower', especially since both speakers reference both the acronym and the word.",
  },
  {
    ...
    audio: "41-45_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "Both the salesman and the prospective customer mention the best answer: 'Swap out the aluminum propeller for a stainless steel one.' This is because she already has an aluminum propeller on her boat, yet she will get the propeller replaced (or 'swapped out') with a stainless steel one through this store.",
  },
  {
    ...
    audio: "41-45_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "At the beginning of the recording, the salesman mentions the name of where he works: 'Boat Chalet'.",
  },
  {
    ...
    audio: "41-45_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "The salesman mentions this in his presentation to the prospective customer as her boat speed will jump 'from 5 miles per hour to over 8 miles per hour, a 60% increase' by upgrading to the stainless steel propeller.",
  },
  {
    ...
    audio: "41-45_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "She refers to 'the stainless steel propeller' as 'the stainless', but it's very clear at the end of their conversation that she is planning on purchasing from Mark's shop: 'a 10 hp motor and a stainless steel propeller'.",
  },
  ...
  },
  {
    ...
    audio: "46-48_toeic1.mp3",
    explanation:
      "The agent mentions: '...please unplug your modem and let it sit for sixty seconds, then plug it back in again.' Therefore, the best answer is: 'Unplug the modem for sixty seconds and then plug it back in again.'",
  },
  {
    ...
    audio: "46-48_toeic1.mp3",
    explanation:
      "The phrase 'down the road' means: 'Later on sometime (not specific)'. It's a general phrase that doesn't have specificity in terms of timing.",
  },
  {
    ...
    explanation:
      "At the beginning of the conversation, the woman mentions: 'Would you mind training Irene...?' Hence, the correct answer to the question about 'the' (only one employee is being trained) new employee being trained is: 'Irene'.",
  },
  {
    ...
    audio: "49-53_toeic1.mp3",
    explanation:
      "'David will probably not return to work at all.' This answer is correct because he will be leaving the company for good to take care of his growing family. He and his wife are moving in with her parents presumably in order to save money and strategize for their next moves professionally.",
  },
  {
...

  {
    ...
    audio: "49-53_toeic1.mp3",
    explanation:
      "The correct answer is stated in the conversation by the male employee, referring to David: '...after his wife, Alexis, delivered their baby.' Hence, the correct answer is: 'His wife, Alexis, is delivering their baby.'",
  },

  {
    ...
    audio: "49-53_toeic1.mp3",
    explanation:
      "This is stated early in the conversation as the female manager asks the employee: 'Listen, would you mind training Irene on the cash register and on filling out her timecard by Friday at the close of business?' Unless the speaker mentions 'next Friday' or a descriptor with more specificity like 'three Fridays from now', for example, then the sentence refers to the current upcoming Friday ('by Friday...'). Hence, the correct answer is: 'by the current Friday'.",
  },

  {
    ...
    explanation:
      "At the beginning of this conversation, the employee inquires: 'Are you Kozeta, the Human Resources Manager?' Hence, the correct answer is: 'Kozeta'.",
  },

  {
    ...
    audio: "54-58_toeic1.mp3",
    explanation:
      "The employee states early in the conversation: 'I’ve been working as a full-time employee of this company...' The HR Manager then explains: 'FTEs like you...'. Therefore, the correct answer is: 'full-time employee'.",
  },
  {
    ...
    audio: "54-58_toeic1.mp3",
    explanation:
      "The HR Manager clearly states to the employee: 'FTEs like you can get fifteen paid sick days off per calendar year.' Hence, the correct answer is: '15'.",
  },
  {
    ...
    audio: "54-58_toeic1.mp3",
    explanation:
      "The HR Manager explains to the full-time employee: '...you do get twenty-one days of holiday leave per year as an FTE.' Therefore, the correct answer is: 'FTEs get 21 unpaid days off for holidays.'",
  },
  {
    ...
    audio: "54-58_toeic1.mp3",
    explanation:
      "The employee states clearly early in the conversation: 'I’ve been working as a full-time employee of this company for one year...'. Hence, the correct answer is: 'One'.",
  },
  {
    ...
    explanation:
      "The two employees discuss that 'the number of registered students [for the graduate programs] has...dropped this year...' Hence, the correct answer is: 'Graduate programs'.",
  },
  {
    ...
    audio: "59-62_toeic1.mp3",
    explanation:
      "'[The] certificate program registration numbers have spiked.' The word 'spiked' means 'to increase dramatically'. Hence, the correct answer is: 'Certificate programs'.",
  },
  {
    ...
    audio: "59-62_toeic1.mp3",
    explanation:
      "The very first statement in the employee conversation is: 'The Dean has called a special meeting.' Hence, the correct answer is: 'the Dean of the school'.",
  },
  {
    ...
    audio: "59-62_toeic1.mp3",
    explanation:
      "The only choice that is not mentioned in the conversation is: 'Their school attended fewer online college fairs this year.'",
  },
  {
    ...
    explanation:
      "The Front Desk woman states early in the conversation: '[Michel] is out for the entire week.' Hence, the correct answer is: 'A week'.",
  },

  {
    ...
    audio: "63-66_toeic1.mp3",
    explanation:
      "The Front Desk woman states early in the conversation: '[Michel's] family is heading out of town for a vacation to visit family for a wedding.' Therefore, the correct answer is: 'He and his family are heading out of town for a wedding.'",
  },

  {
    ...
    audio: "63-66_toeic1.mp3",
    explanation:
      "The contractor states: 'It’s information for him to write me a Letter of Recommendation for the [PhD] program.' Hence, the correct answer is: 'He wants a Letter of Recommendation for a PhD Program he’s applying for.'",
  },
  {
    ...
    audio: "63-66_toeic1.mp3",
    explanation:
      "The Front Desk woman states: '[Michel] explicitly told all of us that he is not going to check any emails nor is he available for any phone calls during the week.' Hence, the correct answer is: 'They can’t. He is not checking emails nor is he taking any calls.'",
  },

  {
    ...
    explanation:
      "The diary-writer relays about his company and team: '...we are changing our sales process from a three-call process to a two-call process.' Hence, the correct answer is: 'switch to a two-call sales process (from a three-call sales process)'.",
  },
  {
    ...
    audio: "67-70_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'My team is exceptional and I think they appreciate my policy of non-micro-management.' This sentence along with the general tone and language of the diary-writer makes it more likely that he's not the 'Chief Executive Officer', but rather that he's the 'Sales Manager'.",
  },
  {
    ...
    audio: "67-70_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'Hence, we changed to an opener pitch which is under one minute.' This sentence clearly relays the correct answer: 'under one minute'.",
  },
  {
    ...
    audio: "67-70_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'It's still early, yet our preliminary data suggests that...' This sentence clearly connects the word 'early' with the word 'preliminary'. Hence, the correct answer is: 'early'.",
  },

  {
    ...
    explanation:
      "In the one-person recording, Sowell was described as 'a recipient of the National Humanities Medal from President George W. Bush back in 2002.' Hence, the correct answer is: 'the National Humanities Medal from President George W. Bush'.",
  },
  {
    ...
    audio: "71-74_toeic1_daniela_vo.mp3",
    explanation:
      "The book mentioned in the recording whereby he expresses opposition to government-mandated minimum wages is the correct answer: 'Basic Economics'.",
  },
  {
    ...
    audio: "71-74_toeic1_daniela_vo.mp3",
    explanation:
      "'He has written over 45 books...' This sentence opening clearly relays the correct answer: 'About 45'.",
  },

  {
    ...
    audio: "71-74_toeic1_daniela_vo.mp3",
    explanation:
      "Towards the end of the recording, the speaker describes Sowell as being somewhere between a 'Republican' and a 'libertarian'. Therefore, the correct answer is: 'Republican and Libertarian'.",
  },

  {
    ...
    audio: "75-78.mp3",
    explanation:
      "The audio diary recorder relays: 'I’ve been scrolling and reading online right up until bedtime.' He also mentions, 'I need to also go to sleep at the same time each and every night.' Therefore, the correct answer is: 'going to bed a different time each night and eating/drinking/using digital devices within an hour of bedtime'.",
  },
  {
    ...
    audio: "75-78.mp3",
    explanation:
      "Wayne relays towards the end of the recording: 'My new strategy is bedtime at 10:30PM no exceptions. I will wake at 6:30AM no exceptions. And I will turn off devices and I will not eat or drink anything within 1 hour of bedtime.' Hence, the correct answer is: 'sleep at the same time each night, get up at the same time each morning, and no devices/eating/drinking within an hour of bedtime'.",
  },
  {
    ...
    audio: "75-78.mp3",
    explanation:
      "'Maybe I will start to lock food up where it’s hard to get to or I can eat out more often, cheaply but healthily.' This sentence relays the correct answer: 'locking up food where it’s hard to get to or where he can eat out more often, cheaply but healthily'.",
  },
  {
    ...
    audio: "75-78.mp3",
    explanation:
      "'I will wake at 6:30AM no exceptions.' This sentence clearly relays the correct answer: '6:30AM'.",
  },

  {
    ...
    image: "img/79-82.png",
    explanation:
      "The speaker concludes that the task, 'though it’s herculean, it’s definitely not impossible.' This phrase clearly illustrates that the correct answer is: 'Challenging'.",
  },
  {
    ...
    image: "img/79-82.png",
    explanation:
      "The speaker mentions the number of team members in the phrase: 'our collective team of fifteen between the sales and marketing departments'. Hence, the correct answer is: '15'.",
  },
  {
    ...
    image: "img/79-82.png",
    explanation:
      "The phrase is defined in the recording with the passage: 'We may need to burn the candle at both ends and come in early and stay late...' Hence, the correct answer is: 'Work overtime or stay later than normal'.",
  },
  {
    ...
    image: "img/79-82.png",
    explanation:
      "'We need to cull the herd, as it were, in order to get rid of this excess inventory that we’re sitting on from last year.' This passage clearly describes 'cull the herd' in this context as the correct answer: 'It means trying to sell the excess inventory as soon as possible.'.",
  },

  {
    ...
    audio: "83-86.mp3",
    explanation:
      "In this short talk, Isaac Newton was mentioned along with the subject, 'infinitesimal calculus, the mathematics discipline that he arguably created...' Hence, the correct answer is: 'Calculus'.",
  },
  {
    ...
    audio: "83-86.mp3",
    explanation:
      "The short talk relays: 'Born in 1643 in Woolsthorpe, England, Newton was always intellectually curious...' Hence, the correct answer is: 'Woolsthorpe, England'.",
  },
  {
    ...
    audio: "83-86.mp3",
    explanation:
      "The speaker describes Newton as a man who 'develop[ed]...theories on - among other things - infinitesimal calculus...' This passage as well as the fact that the prefix 'poly' means 'many' relays the correct answer: 'someone good at many different disciplines'.",
  },
  {
    ...
    audio: "83-86.mp3",
    explanation:
      "The speaker describes calculus as a discipline that Newton 'arguably created'. Hence, when there is a direct counter-point in the passage mentioning, '...Leibniz [as] the rightful progenitor of the discipline...' Therefore, the correct answer is a synonym of 'creator', which is 'inventor'.",
  },

  {
    ...
    explanation:
      "'Orgesa here with Balkan Weather 24/7.' This opening clearly relays the correct answer: 'Balkan Weather 24/7'.",
  },

  {
    ...
    audio: "87-91_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'The historically-heavy rainfall in Peja, Kosovo...' This passage opening relays the correct answer: 'Peja'.",
  },
  {
    ...
    audio: "87-91_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'Orgesa here...' This opening introduction relays the correct answer: 'Orgesa'.",
  },
  {
    ...
    audio: "87-91_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'The historically-heavy rainfall in Peja, Kosovo has not abated even with the warmer temperatures. In fact, we expect to see even more rainfall in that region during the next week...' This passage relays the correct answer: 'decreased or lessened'.",
  },
  {
    ...
    audio: "87-91_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "'If you're flying into Tirana, you may experience delays as there is a worker strike at the airport and may last for the next few days.' This passage clearly relays the correct answer: 'There is a worker strike at the Tirana Airport.'.",
  },
  {
    ...
    audio: "92-96.mp3",
    explanation:
      "The name of the county is mentioned once by the speaker: 'Davison County'.",
  },

  {
    ...
    audio: "92-96.mp3",
    explanation:
      "The speaker mentions 'Davison County' early in his talk, then he later mentions 'this wonderful county' as it is the county's budget that he is discussing. Hence, the correct answer is: 'His county may vote on defunding the arts and the local public libraries.'",
  },

  {
    ...
    audio: "92-96.mp3",
    explanation:
      "The only job that the speaker doesn't mention is the correct answer: 'farmer'.",
  },
...

  {
    ...
    //daniela vo -a0
    qType: "Section 1: Listening Test (Part 4: Short Talks)",
    question: "Based on context clues, what does the word 'egalitarian' mean?",
    choices: ["A) fair", "B) unfair", "C) tasty", "D) competitive"],
    correctAnswer: 0,
    audio: "92-96.mp3",
    explanation:
      "The speaker clearly explains the opposing counter-point to keeping the 'egalitarian places' - or libraries - funded and open, using the phrase:'away from fairness'. Hence, the correct answer is: 'fair'.",
  },
  {
    ...
    explanation:
      "At the very beginning of the recording, the speaker clearly relays the correct answer: 'Superb Leather Goods'.",
  },

  {
    ...
    audio: "97-100_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "The only language not mentioned is the correct answer: 'Brazilian'.",
  },

  {
    ...
    audio: "97-100_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "The correct answer is clearly stated: 'We ship internationally to 22 countries...' Therefore, the correct answer is: '22'.",
  },

  {
    ...
    audio: "97-100_toeic1_daniela_vo_DONE.mp3",
    explanation:
      "The leather good not mentioned is the correct answer: 'baseball cap'.",
  },
  {
    ...
    explanation:
      "The only answer that makes sense is 'high'. The price can't rise to a 'low' because a 'low' means the lowest price during that timeframe. Also, the other two options don't make logical or grammatical sense ('price', 'below average').",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "Since it wouldn't make sense to say, 'It is legs are crossed...', the correct answer is: 'Its'. The other two choices are plainly incorrect.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'their' is an adjective that reflects ownership and is the correct answer ('their...reports').",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The correct answer needs to be a synonym of 'chief' or 'main' or 'primary'. Hence, the correct answer is: 'principal'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The correct answer is an opposite counter-point to 'lower'. Hence, the correct answer is: 'enhance'. While 'further' seems decent as it is more expansive and positive, the phrase 'further his/her grades' doesn't make grammatical sense.",
  },
  {
    ...
    choices: ["A) appointed", "B) appointee", "C) appointments", "D) pointer"],
    correctAnswer: 1,
    image: "img/101-140.png",
    explanation:
      "The correct answer is: 'appointee'. This is the only word that makes clear logical and grammatical sense in the context of the sentence since an 'appointee' is 'someone who is appointed to do something'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The sentence relays the speaker's 'taking a late lunch' while also conceding that it's a 'bummer not to be able to [eat lunch with co-workers].' Hence, the correct answer is: 'However'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only word that makes clear logical and grammatical sentence is: 'While'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "A 'follow-up' is a second (or perhaps third or even fourth or even later) interaction with a prospect when trying to convert him/her to a customer. The hyphen makes the word a noun in this case and it is the only word that makes clear sense. Hence, the correct answer is: 'follow-up'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only word that makes logical and grammatical sense is: 'contact'.",
  },

  {
    ...
    image: "img/101-140.png",
    explanation:
      "The correct answer is: 'but'. The comma right before the word in question negates the other potential options ('still', 'in fact') because those two words require a semi-colon or period to break the sentence into two in order to make sense grammatically.",
  },
  ...
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only word that makes sense is: 'venture'. The word 'venture' here is not used as a verb, but instead is used as a noun and it describes 'a business operation or startup operation'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The phrase 'a concerted effort' is common in everyday parlance. The word 'effort' is the only word that fits in the blank space as none of the other words fit logically.",
  },
  {
...

  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only option where it is grammatically correct to omit a comma right after the word in question posed at the very beginning of this sentence is: 'Despite'. It just so happens that this word also makes the sentence make clear logical sense.",
  },
  {
  ...
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'inception' has to do with something 'commencing' or 'starting'. Hence, the word 'inception' is the correct answer since it makes logical and grammatical sense.",
  },
  {
  ...
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'honored' makes the most sense here ('was honored with a plaque').",
  },
  {
  ...
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'collaborated' is the only word choice that fits in this blank space ('[They] collaborated on all the designs...').",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only word that makes sense with 'has improved' is 'acumen' as 'failures has improved', 'failings has improved', and 'smarts has improved' don't make grammatical sense.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only word that makes sense when keeping in mind the word 'today' is the correct answer: 'doesn't'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The description featured in the sentence is one of 'a large meeting room at a company', which is 'a conference room'. Hence, the word 'conference' is the best answer here.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'Whenever' is correct because the sentence is describing anytime that an employee wants to raise his/her voice at his/her Manager. Hence, the word 'Whenever' is the best answer here.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word in the blank space is a noun so 'hereditary' is incorrect. The word 'trait' makes the most sense because the act of listening well is a positive attribute, or 'trait', that one can develop as a professional and/or as an adult in general. Hence, the correct answer is: 'trait'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'paramount' makes the most sense because it is a synonym of 'crucial' or 'very important'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'sufficient' is the only answer that makes sense here because 'a sufficient salary' is able to cover 'all...bills plus [savings]'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'strike' is correct because workers 'go on strike' when they want to protest working conditions, etc. and they believe that there is no other diplomatic way to be heard by Management.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'warranted' is correct as the other answers are clearly incorrect. The phrase 'an interview would be warranted' is common in the business world as it means that 'an interview would be needed'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'vied' is correct because if someone 'vies for a position', it means that he/she is 'working diligently and interviewing as well as he/she can to earn a position'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'winnow' in the business world to 'reduce' and is used often when referring to reducing the number of candidates for a job opening ('winnow the number of candidates down'). Hence, the correct answer is: 'winnow'.",
  },

  {
    ...
    image: "img/101-140.png",
    explanation:
      "Since the CTO won 'an award...for his efforts', then the correct word in the blank must be positive and must be an adjective that is a synonym of 'great' or 'excellent'. Hence, the correct answer is: 'exemplary'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'continued' is incorrect here because the competitor has let the speaker's company 'surge past them in overall revenues...'. Hence, the correct answer is: 'neglected'.",
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The word 'superior' makes logical sense here because the word 'moreover' is a word that introduces evidence that supports the evidence laid out in the previous sentence or independent clause ('Our product is superior to theirs;'). A synonym of 'moreover' is 'additionally'. Hence, the correct answer is 'superior' since a product that is 'cheaper' and 'better for the environment' are all similarly positive and can all be logically connected via the word 'moreover'.",
  },
  {
  ...
  },
  {
    ...
    image: "img/101-140.png",
    explanation:
      "The only phrase that makes logical and grammatical sense here (much less the entire sentence) is 'surged in the polls'. A poll is a measurement of how an election is going in terms of votes, who is ahead, who is losing, etc. Hence, the correct answer is: 'polls'.",
  },
  {
    //#141 https://docs.google.com/document/d/14UistIVHoRWB9E-esKV2j8qHSQ_F9g7encvbDJhqR5g/edit
    //c2
    qType: "Section 2: Reading (Part 6: Error Recognition or Text Completion)",
    ...
    explanation:
      "The correct answer will be a synonym of 'good' or 'excellent' or 'terrific'. The only synonym of those words is the correct answer: 'superlative'.",
  },
  {
    ...
    image: "img/141-144.png",
    explanation:
      "The phrase 'take copious notes' is the only one that makes sense here as 'copious' is an adjective that means 'lots of' or 'thorough'.",
  },
  {
    ...
    image: "img/141-144.png",
    explanation:
      "The phrase 'for your future reference' is a common one in the business world. This phrase fits appropriately here as the correct answer is: 'reference'.",
  },
  {
    ...
    image: "img/141-144.png",
    explanation:
      "The only word that makes logical sentence in the context of the sentence and the entire passage is 'annual' ('our annual holiday party').",
  },
  {
    ...
    explanation:
      "The phrase that makes sense in a business context and in the context of this passage is 'a liquidation sale'. The other phrases are not popular in the lexicon of commerce and are clearly incorrect. Hence, the correct answer is: 'liquidation'.",
  },
  {
    ...
    image: "img/145-149.png",
    explanation:
      "The ad requests that 'local community members' come and buy items at their going-out-of-business sale. The other words are incorrect as the correct answer is: 'community'.",
  },
  {
    ...
    image: "img/145-149.png",
    explanation:
      "The correct answer is 'manufacturer's' because there is presumably only one manufacturer and not a slew of them. Also, the phrase 'manufacturer's warranty' is a common one in the business world.",
  },
  {
    ...
    image: "img/145-149.png",
    explanation:
      "The correct phrase is: 'You/'re gonna love the prices...'. Hence, the correct answer is: 'You/'re'.",
  },
  {
    ...
    image: "img/145-149.png",
    explanation:
      "The phrase that makes clear logical sense is: 'We look forward to seeing you down there!'. Hence, the word 'forward' is the correct answer.",
  },
  {
    ...
    choices: ["A) joint", "B) unique", "C) collaborative", "D) collaboration"],
    correctAnswer: 1,
    image: "img/150-153.png",
    explanation:
      "The correct answer is 'unique' because the phrase '1 and the number itself' indicate that each of the two numbers being discussed are separate, distinct numbers.",
  },

  {
    ...
    image: "img/150-153.png",
    explanation:
      "A 'conveyance' is 'something that transports things and/or people somewhere' while 'simple' and 'opaque' are adjectives. Hence, the correct answer is 'illustration' since the description in the above passage can be considered an 'illustration'.",
  },
  {
    ...
    image: "img/150-153.png",
    explanation:
      "The word 'basis' fits best here. While 'base' looks tempting, the word 'basis' is a bit less generic and matches the correct Math nomenclature ('the basis on which integers are built').",
  },
  {
    ...
    image: "img/150-153.png",
    explanation:
      "The word 'thrive' is correct because the final message of the passage is encouraging people in 'tech or engineering' should understand prime numbers in order to do well in their career. Hence, the correct answer is 'thrive'.",
  },
  //changed
  {
    ...
    explanation:
      "The word 'embroiled' is correct as this phrase is common in the business world: 'being embroiled in another round of layoffs'. The other words are clearly incorrect.",
  },
  {
    ...
    qType: "Section 2: Reading (Part 6: Error Recognition or Text Completion)",
    question: "Please read the memo and choose the best answer.",
    choices: ["A) tertiary", "B) central", "C) subordinate", "D) subordinated"],
    correctAnswer: 1,
    image: "img/154-158.png",
    explanation:
      "An 'inter-office memo' about corporate layoffs probably will not skip the first two reasons and start with explaining the 'tertiary' -- or 'third' -- reason why there are more layoffs at the company. Hence, the correct answer is 'central' because it is synonymous with 'main' or 'chief' or 'primary'.",
  },
  {
  ...
  },
  {
    ...
    image: "img/154-158.png",
    explanation:
      "The tone of this letter is not upbeat since it covers a business' challenging days of mass layoffs. Hence, the adverb 'regretfully' fits and is the correct answer here.",
  },
  {
    ...
    image: "img/154-158.png",
    explanation:
      "'Thank you for your service with our firm...' This phrase makes clear logical and grammatical sense and the word 'service' is the correct answer.",
  },

  {
    ...
    explanation:
      "'Included are estimates from five separate local service providers...' This passage clearly relays that the correct answer is: 'estimates from five local service providers regarding the garage damage.'",
  },
  {
  ...
  },
  {
    ...
    image: "img/159-163.png",
    explanation:
      "The letter clearly describes that 'their estimates vary between $3,000 and $4,800.' Hence, the correct answer is: '$3000-$4800'.",
  },
  {
    ...
    image: "img/159-163.png",
    explanation:
      "The tone of the letter is cordial which is 'respectful, yet not overly friendly.' Hence, the correct answer is 'cordial'.",
  },
  {
    ...
    image: "img/159-163.png",
    explanation:
      "The correct answer which is clearly stated towards the end of the letter is 'that she be able to get a higher payout for the insurance claim she filed from the garage damage from the tornado'.",
  },

  {
    ...
    explanation:
      "Rachel mentions that Frank and the others that she is emailing are district sales managers ('[He] wants me to train each of you as the District Sales Managers...'). Hence, the correct answer is: 'District Sales Manager'.",
  },

  {
    ...
    image: "img/164-169.png",
    explanation:
      "The strategy is the CEO's as evidenced in the letter's opening: 'I wanted to share with you the CEO's new strategy for sales outreach...'.",
  },
  {
    ...
    image: "img/164-169.png",
    explanation:
      "As mentioned in the letter: 'All of our Sales Professionals will halt their in-person cold calling efforts.' Hence, the correct answer is: 'salespeople will not be doing in-person cold calls'.",
  },

  {
    ...
    image: "img/164-169.png",
    explanation:
      "The correct answer as stated in the letter is: 'the low-priced products they're marketing haven't been selling'.",
  },
  {
    ...
    image: "img/164-169.png",
    explanation:
      "The sales methods not mentioned in the email are 'group webinars'.",
  },

  {
    ...
    image: "img/164-169.png",
    explanation:
      "Rachel's role at the company is 'Regional Sales Manager - Western US'. This is stated at the end of the letter as part of her signature line.",
  },
  {
    ...
    explanation:
      "The population of Antarctica is stated in the table as '3000'. It's in the first data column from the left towards the top (Continent -> Antarctica -> Population).",
  },

  {
    ...
    image: "img/170-174.png",
    explanation:
      "The correct answer as illustrated in the table is '0.6%.' It's towards the bottom right listed as '0.60%' (UN Sub-Region -> Caribbean -> % of world).",
  },

  {
    ...
    image: "img/170-174.png",
    explanation:
      "The correct answer as illustrated in the table is '8 billion'. The actual value displayed in the top middle of the table is '7,909,295,151' (Continent -> World -> Population).",
  },

  {
    ...
    image: "img/170-174.png",
    explanation:
      "The correct answer as illustrated in the table is '17.6%'. The percentage is listed as '17.60%' (Continent -> Africa -> % of world).",
  },

  {
    ...
    image: "img/170-174.png",
    explanation:
      "The correct answer as illustrated in the table is 'Southern Asia' (UN Sub-Region -> Southern Asia -> % of world). ",
  },

  {
    ...
    explanation:
      "By process of elimination, one can find the correct answer: 'most valuable companies in the world by market cap'.",
  },

  {
    ...
    image: "img/175-179.png",
    explanation:
      "The correct answer is 'Saudi Aramco' which is listed on the Tadawul (Saudi Stock Exchange).",
  },

  {
    ...
    image: "img/175-179.png",
    explanation:
      "The other name for Saudi Aramco is 'Saudi Arabian Oil' as mentioned at the very beginning of the company description in the table.",
  },

  {
    ...
    image: "img/175-179.png",
    explanation:
      "As described in the company profile, Microsoft is most known for producing 'Windows OS and Office Suite Software'.",
  },

  {
    ...
    image: "img/175-179.png",
    explanation:
      "Though it's not explicitly stated as 'net annual income', the 'Net Income (TTM)' of Apple is the only one over $100 billion in net annual income ($100.5 billion).",
  },

  {
    ...
    explanation:
      "The memo is clearly the following: 'tips of being thorough and conscientious on the job'.",
  },

  {
    ...
    image: "img/180-185.png",
    explanation:
      "The memo is written for 'new team members of a company' and the evidence is in the final body sentence: 'Thank you and WELCOME to our company!'.",
  },

  {
    ...
    image: "img/180-185.png",
    explanation:
      "The word 'proofreading' is being used as a 'metaphor or figure of speech' in the memo.",
  },

  {
    ...
    image: "img/180-185.png",
    explanation:
      "The writer of the memo mentions all of the answer choices except 'names of fellow team members who are doing a good job 'proofreading' at the company'.",
  },

  {
    ...
    image: "img/180-185.png",
    explanation:
      "The writer of the memo is the 'Founder' as stated at the bottom.",
  },

  {
    ...
    image: "img/180-185.png",
    explanation:
      "The memo writer claims not to engage in 'micro-managing' his team members.",
  },
  {
    ...
    explanation:
      "Buddha taught about 'compassion and inner peace' (last sentence of his profile).",
  },

  {
    ...
    image: "img/186-190.png",
    explanation:
      "The correct answer is: 'They were religious teachers and/or figures.'",
  },

  {
    ...
    image: "img/186-190.png",
    explanation:
      "The correct answer about Alexander the Great: 'He was one of the greatest military generals in history'.",
  },

  {
    ...
    image: "img/186-190.png",
    explanation:
      "Julius Caesar's philosophy is known as 'Caesarism' as stated in his profile.",
  },

  {
    ...
    image: "img/186-190.png",
    explanation:
      "Alexander the Great was a student of 'Aristotle' as mentioned in his profile.",
  },
  {
    ...
    explanation:
      "The word 'severally' in Nigerian English means 'on several occasions; repeatedly'.",
  },

  {
    ...
    image: "img/191-195.png",
    explanation:
      "In the very beginning of the text, Nigeria is described as being a country in 'West Africa'.",
  },

  {
    ...
    image: "img/191-195.png",
    explanation:
      "According to the first paragraph of the passage, the correct answer is '500' as being the number of languages that are spoken in Nigeria.",
  },

  {
    ...
    image: "img/191-195.png",
    explanation:
      "English was introduced to Nigeria during the 'pre-colonial' period according to the text.",
  },
  ...
  },
  {
    ...
    explanation:
      "The person's title who wrote the letter is 'Institutional Outreach'.",
  },

  {
    ...
    image: "img/196-200.png",
    explanation:
      "The letter is offering 'free Math and Coding tutoring' for students and staff of a school in Nigeria.",
  },

  {
    ...
    image: "img/196-200.png",
    explanation:
      "The offer is for 'students and/or staff of a specific school'.",
  },

  {
    ...
    image: "img/196-200.png",
    explanation:
      "In the top left of the letter is the address where the letter was sent: 'Lagos State, Nigeria'.",
  },

  {
    ...
    image: "img/196-200.png",
    explanation:
      "The name of the contract that is discussed in the letter is 'Memorandum of Understanding'.",
  },
];
